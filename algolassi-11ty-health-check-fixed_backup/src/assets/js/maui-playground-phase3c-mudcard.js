...
(function () {
  ...
  function installDemoFiles() {
    ...
    setTimeout(function () {
      ...
      if (output) output.textContent = "Demo loaded: MudCard\n\nMudCard content, actions, and the button interaction are simulated in the browser preview.";
  ...
  function renderMudCard() {
    ...
    content.innerHTML = '<div class="p3c-mudcard-demo"><h2>MudCard</h2><p>Interactive browser preview of <code>&lt;MudCard&gt;</code> with content and actions.</p><div class="p3c-mudcard"><div class="p3c-mudcard-content"><h3>MAUI Hybrid</h3><p>This content is displayed inside a MudCard.</p></div><div class="p3c-mudcard-actions"><button type="button" id="p3c-mudcard-button">Learn More</button></div></div><p id="p3c-mudcard-message"></p></div>';
    addStyles();
