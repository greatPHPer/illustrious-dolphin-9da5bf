  ...
  async function decorate(){
    ...
    try{
      ...
      nodes.forEach(function(node,index){
        ...
        if(!reactionRow){
          reactionRow=document.createElement("div");reactionRow.className="algolassi-chat-reaction-row";
