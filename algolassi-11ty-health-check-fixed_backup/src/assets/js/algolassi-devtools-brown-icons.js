...
(function(){
  "use strict";
  var ICONS={"🏠":'<path d="M3 10.6 12 3l9 7.6"/><path d="M5.5 9.4V21h13V9.4"/><path d="M9 21v-6.5h6V21"/>',"🛠️":'<path d="m14 7 3-3 3 3-3 3"/><path d="m3 21 9-9"/><path d="m12 12 3 3"/><path d="M7 4.5a4.5 4.5 0 0 0 5.8 5.8L20 17.5a2.5 2.5 0 0 1-3.5 3.5l-7.2-7.2A4.5 4.5 0 0 0 3.5 8"/>',"🖼️":'<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9" r="1.5"/><path d="m4.5 17 5-5 3.5 3 2.5-2.5 4 4"/>',"🔄":'<path d="M20 7v5h-5"/><path d="M4 17v-5h5"/><path d="M19.2 12a7 7 0 0 0-12.4-4.4L4 10"/><path d="M4.8 12a7 7 0 0 0 12.4 4.4L20 14"/>',"{}":'<path d="M8 4 4 12l4 8M16 4l4 8-4 8M13 3l-2 18"/>',"🧰":'<rect x="3" y="7" width="18" height="13" rx="2"/><path d="M8 7V5.5A2.5 2.5 0 0 1 10.5 3h3A2.5 2.5 0 0 1 16 5.5V7M3 12h18M10 12v2h4v-2"/>',"📄":'<path d="M6 3h8l4 4v14H6z"/><path d="M14 3v5h5M9 13h6M9 16h6"/>'};
  ...
  function loadScript(id,src){var existing=document.getElementById(id);if(existing){if(existing.getAttribute("src")!==src)existing.setAttribute("src",src);return;}var s=document.createElement("script");s.id=id;s.src=src;s.defer=true;s.async=true;document.head.appendChild(s);}
  function load(){
    if(document.querySelector(".image-workspace")){
      ...
      loadScript("algolassi-image-compress-spa-script","/assets/js/algolassi-image-compress.js?v=20260903-image-compress-2");
    }
  ...
  window.addEventListener("load",init);window.addEventListener("algolassi:spa-navigation",function(){setTimeout(init,0);requestAnimationFrame(init);});
})();