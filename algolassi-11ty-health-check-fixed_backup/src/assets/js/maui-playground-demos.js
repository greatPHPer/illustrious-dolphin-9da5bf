...
(function () {
  ...
  var demos = {
    ...
    "maui-border":{title:"MAUI Border",description:"Create bordered cards with stroke, corner radius, and padding.",category:"MAUI Layouts",xaml:'<Border Stroke="#0d6efd" StrokeThickness="2" StrokeShape="RoundRectangle 12" Padding="16"><VerticalStackLayout Spacing="8"><Label Text="MAUI Border Demo" FontSize="24" /><Label Text="This content is inside a bordered container." /><Button Text="Save" /></VerticalStackLayout></Border>'},
